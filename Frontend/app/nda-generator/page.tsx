...
import { DocumentAdd, Download, Information, CheckmarkFilled, Security, Time, Edit, Save } from "@carbon/icons-react"
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                      <div className="space-y-6">
                        ...
                        >
                          ...
                          <SelectItem value="eu" text="European Union" />
                        </Select>
                    ...
                    {!isGenerated ? (
                        ...
                        <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                          ...
                          <div className="grid md:grid-cols-2 gap-6 text-sm">
                            ...
                            <div className="space-y-3">
                              ...
                              <div>
                                <span className="text-gray-400">Return Period:</span>
                                <div className="text-white font-medium">{ndaForm.returnPeriod} days</div>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                          ...
                          <div className="grid md:grid-cols-3 gap-4 text-sm">
                            ...
                            <div className="text-center">
                              ...
                              <div className="text-gray-400">Clauses</div>
                            </div>
                            <div className="text-center">
                        ...
                        <div className="flex justify-center space-x-4">
                          <button className="px-8 py-3 bg-gradient-to-r from-green-500 to-blue-500 rounded-xl text-white font-semibold transform hover:scale-105 transition-all duration-300">
                            <Download className="mr-2 inline" size={20} />
                            Download PDF
                          </button>
                          <button className="px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl text-white font-semibold transform hover:scale-105 transition-all duration-300">
